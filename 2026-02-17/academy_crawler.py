    ...
    def start(self):
        ...
        for url in urls:
            ...
            while True:
                ...
                if not is_next:
                    self.logger.info("Pagination and Completed ")
                    break
    ...
    def parse_item(self,response):
        ...
        if products:
            ...
            for product in products:
                ...
                pdp_name = product.xpath(PDP_NAME_XPATH).extract_first().strip()
                pdp_rating = product.xpath(PDP_RATING_XPATH).extract_first()
